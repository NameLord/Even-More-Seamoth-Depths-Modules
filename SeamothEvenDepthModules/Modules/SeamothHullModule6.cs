...
namespace EvenMoreSeamothDepth.Modules
{
    ...
    public class SeamothHullModule6: Equipable
    {
        public SeamothHullModule6() : base(
            classId: "SeamothHullModule6",
            friendlyName: "Seamoth depth module MK6",
        ...
        protected override TechData GetBlueprintRecipe()
        {
            return new()
            {
                ...
                {
                    new(TechType.VehicleHullModule3, 2),
                    new(TechType.PlasteelIngot, 1),
                    new(TechType.Nickel, 5),
                    new(TechType.EnameledGlass, 2),
                    new(TechType.HydrochloricAcid, 3),
